...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Admin Panel |
              <%
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link" href="#services">Applied Candidate</a></li>
          <li><a class="nav-link" href="recruiterlist.jsp">Recruiter</a></li>
          <li><a class="nav-link" href="#services">Candidate</a></li>
